...
<main class="page-container">
    <a href="station.php?id=<?php echo $station['Station_ID']; ?>" class="back-link btn-secondary btn-sm">&larr; Back</a>
    <h1>Edit Station Information</h1>
    ...
    <section class="card">
        <form method="post" action="../../controller/StationController.php" onsubmit="return validateStationForm(this)" novalidate>
            ...
            <input type="hidden" name="status" value="<?php echo htmlspecialchars($station['Status']); ?>">
